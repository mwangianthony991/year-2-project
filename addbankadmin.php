...
if(isset($_POST['bankadminadd'])){
  ...
  if (empty($username)) {
    echo "<script>
    window.location.href='addbankadmin.php';
 ...
 <div class="container-fluid text-center">
   <div class="row content">
     ...
     <div class="col-sm-8 text-left">
       ...
       <div class="form">
       <form method="post" action="addbankadmin.php">
       ...
       <fieldset>
        ...
        <p>
           ...
           <input type = "submit" class = "button" name = "bankadminadd">
         </p>
       </fieldset>
       </form>
     </div>
