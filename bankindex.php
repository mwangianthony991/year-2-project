  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="addbankadmin.php">ADD ADMIN</a></li>
        <li><a href="bankpoints.php">TABLE</a></li>
        <li><a href="mychart14/input.php">FEEDBACK CHART</a></li>
