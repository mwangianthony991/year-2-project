<?php include('retailserver.php') ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Retail Admin Login</title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="banklogin.php">BANK ADMIN</a></li>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
      ...
      <div class="form">
        <form method="post" action="retaillogin.php">
        ...
        <fieldset>
          <legend>Personal Information</legend>
            <p>
              ...
              <input type = "submit" class = "button" name = "retaillogin">
            </p>
        </fieldset>
        </form>
    </div>
