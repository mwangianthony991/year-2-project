...
if(isset($_POST['retailadminadd'])){
  ...
  if (empty($username)) {
    echo "<script>
    window.location.href='addretailadmin.php';
 ...
 <div class="container-fluid text-center">
   <div class="row content">
     ...
     <div class="col-sm-8 text-left">
       ...
       <div class="form">
       <form method="post" action="addretailadmin.php">
       ...
       <fieldset>
        ...
        <p>
           ...
           <input type = "submit" class = "button" name = "retailadminadd">
         </p>
       </fieldset>
       </form>
     </div>
