...
<html lang="en">
<head>
  <title>Retail Admin Index</title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="addretailadmin.php">ADD ADMIN</a></li>
        <li><a href="coupontable.php">TABLE</a></li>
        <li><a href="mychart15/input.php">FEEDBACK CHART</a></li>
